...
class GiftedView extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.onShowToolbarChange = () => {
            this.setMinInputToolbarHeight(this.props.shouldShowToolbar ? this.props.minInputToolbarHeight : 0)
        ...
        this.onKeyboardWillHide = (_e) => {
            ...
            this.setMinInputToolbarHeight(0)
            this.blurTextInput()
    ...
    componentDidUpdate(nextProps) {
        if (nextProps.shouldShowToolbar !== this.props.shouldShowToolbar) {
            this.onShowToolbarChange()
        }
    }
    ...
    setMinInputToolbarHeight(height) {
        this._minInputToolbarHeight = height;
    }
    ...
    getMinInputToolbarHeight() {
        return this.props.renderAccessory
            ? (this.props.inputToolbarHeight || this._minInputToolbarHeight * 2)
            : this._minInputToolbarHeight;
    }
    calculateInputToolbarHeight(composerHeight) {
        if (!this.props.shouldShowToolbar) {
            return 0
        }
    ...
    renderInputToolbar() {
        const inputToolbarProps = {
            ...
            onSend: this.onSend,
            // height: this.props.shouldShowToolbar ? 'auto' : 0,
        ...
        if (this.props.menuTest) {
            return <InputToolbar {...inputToolbarProps}/>
        }
        return <View style={{
            overflow: "hidden",
            height: this.props.shouldShowToolbar ? undefined : 0,
            //opacity: this.props.shouldShowToolbar ? 1 : 0
        }}>
...
GiftedView.childContextTypes = {
    actionSheet: PropTypes.func,
    getLocale: PropTypes.func,
};
GiftedView.defaultProps = {
    messages: [],
    text: undefined,
    ...
    bottomOffset: 0,
    minInputToolbarHeight: Platform.select({
        ios: 44, //100
        android: 44,
    }),
...
export { GiftedView, Actions, Avatar, Bubble, SystemMessage, MessageImage, MessageText, Composer, Day, InputToolbar, LoadEarlier, Message, MessageContainer, Send, Time, GiftedAvatar, utils, };

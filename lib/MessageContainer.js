...
import { FlatList, View, StyleSheet, Keyboard, TouchableOpacity, Text, TextInput } from 'react-native';
...
export default class MessageContainer extends React.PureComponent {
    ...
    render() {
        if (!this.props.messages ||
            ...
            return <View style={styles.container}><TextInput placeholder={'toto'}></TextInput></View>;
        }
